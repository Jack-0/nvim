    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd("LspAttach", {
        ...
        callback = function(event)
          ...
          map("<leader>ne", vim.diagnostic.goto_next, "next error")
          ...
          map("<leader>ga", require("telescope.builtin").lsp_implementations, "[G]oto [I]mplementation")
  ...
  { -- Autocompletion
    ...
    opts = {
      keymap = {
        ...
        ['<Enter>'] = {'accept', 'fallback'} -- User enter to accept <ctrl-y> is not my fav
